...
class CocoaPodsIT : BaseGradleIT() {
    ...
    override fun defaultBuildOptions(): BuildOptions = cocoapodsInstallationPath?.let {
        super.defaultBuildOptions().copy(additionalPath = listOf(it))
    ...
    private fun runCommand(
        ...
        val process = ProcessBuilder(command, *args).apply {
            ...
            environment().put("PATH", getPathEnv())
            if (inheritIO) {
                inheritIO()
            }
        }.start()
